...
class SN_WM_OT_load_snap_defaults(Operator):
    ...
    def execute(self, context):
        ...
        if bl_ver != "3.0":
            ...
            tmp_filepath = os.path.join(tmp_dir, 'SNaP-2.2.3-setup-windows-x64.exe')
            url = 'https://github.com/Classy-Closets/Snap-Update-Testing/releases/download/v2.2.3/SNaP-2.2.3-update-setup-windows-x64.exe'
